...
console.log('🔍 Testing analyze_documents tool with SKIP_CACHE=true...\n');
...
console.log('🚀 Starting MCP server with SKIP_CACHE=true...\n');

// Start the MCP server with skip cache enabled
const server = spawn('node', ['dist/mcp_server_main.js'], {
  stdio: ['pipe', 'pipe', 'pipe'],
  env: { ...process.env, SKIP_CACHE: 'true', DEBUG_MODE: 'true' }
});
...
const analyzeRequest = {
  ...
  params: {
    ...
    arguments: {
      query: "What are the top 5 most popular documents?",
      limit: 5,
      timeframe: "all"
    }
  }
